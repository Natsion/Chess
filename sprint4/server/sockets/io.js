module.exports = io => {
    ...
    io.on('connection', socket => {
        ...
        socket.on("replicateMessage", (message, playerColor) => {
            // Broadcast to all clients in the room, including the player who sent it
            io.to(currentCode).emit("replicateMessage", message, playerColor);
        });        
